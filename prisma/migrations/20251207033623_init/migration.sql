...
-- CreateIndex
CREATE INDEX "Post_boardType_isPublished_publishedAt_idx" ON "public"."Post"("boardType", "isPublished", "publishedAt");

-- CreateIndex
CREATE INDEX "Post_authorId_idx" ON "public"."Post"("authorId");

-- CreateIndex
CREATE INDEX "Post_supportCategory_idx" ON "public"."Post"("supportCategory");

-- CreateIndex
CREATE INDEX "Post_visibility_idx" ON "public"."Post"("visibility");

-- CreateIndex
CREATE INDEX "Post_sourceUrl_idx" ON "public"."Post"("sourceUrl");

-- CreateIndex
CREATE INDEX "Post_tags_idx" ON "public"."Post" USING GIN ("tags" array_ops);

-- CreateIndex
CREATE INDEX "SupportAssignment_assigneeId_idx" ON "public"."SupportAssignment"("assigneeId");
...
-- CreateIndex
CREATE INDEX "Comment_isPrivate_idx" ON "public"."Comment"("isPrivate");

-- CreateIndex
CREATE UNIQUE INDEX "CenterManager_userId_key" ON "public"."CenterManager"("userId");

-- CreateIndex
CREATE INDEX "CenterManager_isActive_effectiveTo_idx" ON "public"."CenterManager"("isActive", "effectiveTo");

-- CreateIndex
CREATE INDEX "CenterManager_createdAt_idx" ON "public"."CenterManager"("createdAt");

-- CreateIndex
CREATE INDEX "UserCenterLink_userId_distance_rank_idx" ON "public"."UserCenterLink"("userId", "distance", "rank");

-- CreateIndex
CREATE INDEX "UserCenterLink_userId_rank_idx" ON "public"."UserCenterLink"("userId", "rank");

-- CreateIndex
CREATE INDEX "UserCenterLink_centerUserId_idx" ON "public"."UserCenterLink"("centerUserId");

-- CreateIndex
CREATE UNIQUE INDEX "UserCenterLink_userId_centerUserId_key" ON "public"."UserCenterLink"("userId", "centerUserId");

-- CreateIndex
CREATE INDEX "CenterCommission_sourceHistoryId_idx" ON "public"."CenterCommission"("sourceHistoryId");

-- CreateIndex
CREATE INDEX "CenterCommission_centerUserId_createdAt_idx" ON "public"."CenterCommission"("centerUserId", "createdAt");

-- CreateIndex
CREATE INDEX "CenterCommission_buyerUserId_createdAt_idx" ON "public"."CenterCommission"("buyerUserId", "createdAt");

-- CreateIndex
CREATE INDEX "CenterCommission_status_createdAt_idx" ON "public"."CenterCommission"("status", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "CenterCommission_centerUserId_sourceHistoryId_key" ON "public"."CenterCommission"("centerUserId", "sourceHistoryId");

-- CreateIndex
CREATE INDEX "CoinPrice_tokenCode_createdAt_idx" ON "public"."CoinPrice"("tokenCode", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "ContactLink_typeCode_isActive_sortOrder_idx" ON "public"."ContactLink"("typeCode", "isActive", "sortOrder");

-- CreateIndex
CREATE UNIQUE INDEX "ContactLink_typeCode_label_key" ON "public"."ContactLink"("typeCode", "label");

-- CreateIndex
CREATE UNIQUE INDEX "LevelPolicy_name_key" ON "public"."LevelPolicy"("name");

-- CreateIndex
CREATE INDEX "LevelPolicyLevel_policyId_level_idx" ON "public"."LevelPolicyLevel"("policyId", "level");

-- CreateIndex
CREATE UNIQUE INDEX "LevelPolicyLevel_policyId_level_key" ON "public"."LevelPolicyLevel"("policyId", "level");

-- CreateIndex
CREATE INDEX "LevelRequirementGroup_levelId_ordinal_idx" ON "public"."LevelRequirementGroup"("levelId", "ordinal");

-- CreateIndex
CREATE INDEX "LevelRequirement_groupId_kind_idx" ON "public"."LevelRequirement"("groupId", "kind");

-- CreateIndex
CREATE UNIQUE INDEX "LevelRecalcJob_dedupeKey_key" ON "public"."LevelRecalcJob"("dedupeKey");

-- CreateIndex
CREATE INDEX "LevelRecalcJob_status_scheduledAt_id_idx" ON "public"."LevelRecalcJob"("status", "scheduledAt", "id");

-- CreateIndex
CREATE UNIQUE INDEX "LevelWorkerConfig_key_key" ON "public"."LevelWorkerConfig"("key");

-- CreateIndex
CREATE INDEX "MlmReferralPlanLevel_planId_level_idx" ON "public"."MlmReferralPlanLevel"("planId", "level");

-- CreateIndex
CREATE UNIQUE INDEX "MlmReferralPlanLevel_planId_level_key" ON "public"."MlmReferralPlanLevel"("planId", "level");

-- CreateIndex
CREATE INDEX "LevelBonusItem_planId_level_idx" ON "public"."LevelBonusItem"("planId", "level");

-- CreateIndex
CREATE UNIQUE INDEX "LevelBonusItem_planId_level_key" ON "public"."LevelBonusItem"("planId", "level");

-- CreateIndex
CREATE UNIQUE INDEX "MlmReferralPlan_name_key" ON "public"."MlmReferralPlan"("name");

-- CreateIndex
CREATE UNIQUE INDEX "LevelBonusPlan_name_key" ON "public"."LevelBonusPlan"("name");

-- CreateIndex
CREATE UNIQUE INDEX "MiningPolicy_name_key" ON "public"."MiningPolicy"("name");

-- CreateIndex
CREATE INDEX "MiningPolicy_isActive_effectiveFrom_idx" ON "public"."MiningPolicy"("isActive", "effectiveFrom");

-- CreateIndex
CREATE UNIQUE INDEX "MiningSchedule_name_key" ON "public"."MiningSchedule"("name");

-- CreateIndex
CREATE INDEX "MiningSchedule_isActive_kind_intervalMinutes_idx" ON "public"."MiningSchedule"("isActive", "kind", "intervalMinutes");

-- CreateIndex
CREATE INDEX "MiningSchedule_isActive_kind_dailyAtMinutes_timezone_idx" ON "public"."MiningSchedule"("isActive", "kind", "dailyAtMinutes", "timezone");

-- CreateIndex
CREATE INDEX "MiningRun_status_createdAt_idx" ON "public"."MiningRun"("status", "createdAt");

-- CreateIndex
CREATE INDEX "MiningPayout_beneficiaryUserId_createdAt_idx" ON "public"."MiningPayout"("beneficiaryUserId", "createdAt");

-- CreateIndex
CREATE INDEX "MiningPayout_sourceUserId_createdAt_idx" ON "public"."MiningPayout"("sourceUserId", "createdAt");

-- CreateIndex
CREATE INDEX "MiningPayout_kind_createdAt_idx" ON "public"."MiningPayout"("kind", "createdAt");
...
-- CreateIndex
CREATE INDEX "ReferralCommission_beneficiaryUserId_createdAt_idx" ON "public"."ReferralCommission"("beneficiaryUserId", "createdAt");

-- CreateIndex
CREATE INDEX "ReferralCommission_buyerUserId_createdAt_idx" ON "public"."ReferralCommission"("buyerUserId", "createdAt");

-- CreateIndex
CREATE INDEX "ReferralCommission_historyId_idx" ON "public"."ReferralCommission"("historyId");

-- CreateIndex
CREATE INDEX "ReferralCommission_status_createdAt_idx" ON "public"."ReferralCommission"("status", "createdAt");

-- CreateIndex
CREATE INDEX "ReferralEdge_parentId_groupNo_position_idx" ON "public"."ReferralEdge"("parentId", "groupNo", "position");

-- CreateIndex
CREATE INDEX "ReferralEdge_childId_idx" ON "public"."ReferralEdge"("childId");

-- CreateIndex
CREATE UNIQUE INDEX "ReferralEdge_childId_key" ON "public"."ReferralEdge"("childId");

-- CreateIndex
CREATE UNIQUE INDEX "ReferralEdge_parentId_childId_key" ON "public"."ReferralEdge"("parentId", "childId");

-- CreateIndex
CREATE UNIQUE INDEX "ReferralEdge_parentId_groupNo_position_key" ON "public"."ReferralEdge"("parentId", "groupNo", "position");

-- CreateIndex
CREATE INDEX "ReferralGroupSummary_userId_groupNo_idx" ON "public"."ReferralGroupSummary"("userId", "groupNo");

-- CreateIndex
CREATE UNIQUE INDEX "ReferralGroupSummary_userId_groupNo_key" ON "public"."ReferralGroupSummary"("userId", "groupNo");

-- CreateIndex
CREATE UNIQUE INDEX "ReferralPlan_name_key" ON "public"."ReferralPlan"("name");

-- CreateIndex
CREATE INDEX "ReferralPlanLevel_planId_level_idx" ON "public"."ReferralPlanLevel"("planId", "level");

-- CreateIndex
CREATE UNIQUE INDEX "ReferralPlanLevel_planId_level_key" ON "public"."ReferralPlanLevel"("planId", "level");

-- CreateIndex
CREATE INDEX "PackageReferralPlan_planId_idx" ON "public"."PackageReferralPlan"("planId");

-- CreateIndex
CREATE UNIQUE INDEX "PackageReferralPlan_packageId_key" ON "public"."PackageReferralPlan"("packageId");
...
-- CreateIndex
CREATE INDEX "User_sponsorId_idx" ON "public"."User"("sponsorId");
...
-- CreateIndex
CREATE INDEX "UserPackage_packageId_idx" ON "public"."UserPackage"("packageId");

-- CreateIndex
CREATE UNIQUE INDEX "UserPackage_userId_packageId_key" ON "public"."UserPackage"("userId", "packageId");

-- CreateIndex
CREATE INDEX "UserPackageHistory_userId_createdAt_idx" ON "public"."UserPackageHistory"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "UserPackageHistory_packageId_createdAt_idx" ON "public"."UserPackageHistory"("packageId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "UserReferralStats_userId_key" ON "public"."UserReferralStats"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "UserRewardHistory_miningPayoutId_key" ON "public"."UserRewardHistory"("miningPayoutId");

-- CreateIndex
CREATE INDEX "UserRewardHistory_userId_createdAt_idx" ON "public"."UserRewardHistory"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "UserRewardHistory_userId_name_createdAt_idx" ON "public"."UserRewardHistory"("userId", "name", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "UserRewardSummary_userId_key" ON "public"."UserRewardSummary"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "UserWallet_userId_key" ON "public"."UserWallet"("userId");

-- CreateIndex
CREATE INDEX "UserWallet_depositAddress_idx" ON "public"."UserWallet"("depositAddress");

-- CreateIndex
CREATE INDEX "UserWallet_withdrawAddress_idx" ON "public"."UserWallet"("withdrawAddress");

-- CreateIndex
CREATE INDEX "WalletTx_userId_createdAt_idx" ON "public"."WalletTx"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "WalletTx_userId_tokenCode_createdAt_idx" ON "public"."WalletTx"("userId", "tokenCode", "createdAt");

-- CreateIndex
CREATE INDEX "WalletTx_status_createdAt_idx" ON "public"."WalletTx"("status", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "WalletTx_txHash_logIndex_key" ON "public"."WalletTx"("txHash", "logIndex");
