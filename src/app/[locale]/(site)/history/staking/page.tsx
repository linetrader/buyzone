...
export default function StakingHistoryPage() {
  // 스테이킹 수익 내역 더미 데이터
  const historyData = [
    { id: 1, date: "2025-12-07", type: "Daily Reward", package: "Premium Plan ($10,000)", amount: "+ 45.00", status: "지급 완료" },
    { id: 2, date: "2025-12-06", type: "Daily Reward", package: "Premium Plan ($10,000)", amount: "+ 45.00", status: "지급 완료" },
    { id: 3, date: "2025-12-05", type: "Daily Reward", package: "Premium Plan ($10,000)", amount: "+ 45.00", status: "지급 완료" },
    { id: 4, date: "2025-12-04", type: "Daily Reward", package: "Standard Plan ($3,000)", amount: "+ 12.00", status: "지급 완료" },
    { id: 5, date: "2025-12-03", type: "Daily Reward", package: "Standard Plan ($3,000)", amount: "+ 12.00", status: "지급 완료" },
    { id: 6, date: "2025-12-02", type: "Daily Reward", package: "Standard Plan ($3,000)", amount: "+ 12.00", status: "지급 완료" },
    { id: 7, date: "2025-12-01", type: "Daily Reward", package: "Standard Plan ($3,000)", amount: "+ 12.00", status: "지급 완료" },
    { id: 8, date: "2025-11-30", type: "Bonus", package: "Event Bonus", amount: "+ 100.00", status: "지급 완료" },
  ];
    ...
    <div className="w-full bg-base-200/50 min-h-full font-sans transition-colors duration-300">
      <div className="container mx-auto px-4 lg:px-10 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-base-content/60 text-lg ml-1">스테이킹 상품에서 발생한 일일 수익 내역입니다.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="card bg-base-100 shadow-lg border border-base-300">
            <div className="card-body">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-base-content/60 font-medium mb-1">총 누적 수익</p>
                  <h2 className="text-3xl font-bold text-primary">283.00 <span className="text-sm text-base-content/40">USDT</span></h2>
                </div>
          ...
          <div className="card bg-base-100 shadow-lg border border-base-300">
            <div className="card-body">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-base-content/60 font-medium mb-1">이번 달 수익 (12월)</p>
                  <h2 className="text-3xl font-bold text-base-content">183.00 <span className="text-sm text-base-content/40">USDT</span></h2>
                </div>
        ...
        <div className="card bg-base-100 shadow-xl border border-base-300 overflow-hidden">
            ...
            <table className="table table-lg">
              <thead className="bg-base-200/30">
                <tr className="text-base text-base-content/60 border-b border-base-300">
                  <th className="font-normal w-40">지급 일자</th>
              ...
              <tbody>
                {historyData.map((item) => (
                  <tr key={item.id} className="hover:bg-base-200/50 transition-colors border-b border-base-200 last:border-0">
                    ...
                    <td>
                      <div className="font-bold text-base-content text-lg">{item.type}</div>
                      <div className="text-sm text-base-content/40 mt-0.5">{item.package}</div>
                    </td>
                    <td className="text-right">
                      <div className="font-bold text-xl text-primary">{item.amount} <span className="text-xs text-base-content/40">USDT</span></div>
                    </td>
          ...
          <div className="p-6 border-t border-base-300 flex justify-center">
            <div className="join">
              ...
              <button className="join-item btn btn-sm hover:bg-base-200 bg-base-100 border-base-300 text-base-content/60">2</button>
              <button className="join-item btn btn-sm hover:bg-base-200 bg-base-100 border-base-300 text-base-content/60">3</button>
              <button className="join-item btn btn-sm hover:bg-base-200 bg-base-100 border-base-300 text-base-content/60">»</button>
            </div>
          </div>
        </div>
